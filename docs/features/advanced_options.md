...
For what is possible, consult the [`docker-java CreateContainerCmd` source code](https://github.com/docker-java/docker-java/blob/docker-java-3.0.0/src/main/java/com/github/dockerjava/api/command/CreateContainerCmd.java).
