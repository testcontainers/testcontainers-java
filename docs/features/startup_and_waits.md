...
<!--codeinclude--> 
[Waiting for the first exposed port to start listening](../examples/junit5/generic/src/test/java/generic/WaitStrategiesTest.java) inside_block:waitForNetworkListening
<!--/codeinclude-->
...
<!--codeinclude--> 
[](../examples/junit5/generic/src/test/java/generic/WaitStrategiesTest.java) inside_block:waitForHttpWithMultipleStatusCodes
<!--/codeinclude-->

#### Waiting for a status code that matches a predicate
<!--codeinclude--> 
[Waiting for a status code that matches a predicate](../examples/junit5/generic/src/test/java/generic/WaitStrategiesTest.java) inside_block:waitForHttpWithStatusCodePredicate
<!--/codeinclude-->

#### Using TLS
<!--codeinclude--> 
[](../examples/junit5/generic/src/test/java/generic/WaitStrategiesTest.java) inside_block:waitForHttpWithTls
<!--/codeinclude-->
...
<!--codeinclude-->
[](../examples/junit5/generic/src/test/java/generic/WaitStrategiesTest.java) inside_block:healthcheckWait
<!--/codeinclude-->
...
<!--codeinclude--> 
[Using one shot startup strategy](../examples/junit5/generic/src/test/java/org/testcontainers/containers/startupcheck/StartupCheckStrategyTest.java) inside_block:withOneShotStrategy
<!--/codeinclude-->
...
<!--codeinclude--> 
[Using indefinite one shot startup strategy](../examples/junit5/generic/src/test/java/org/testcontainers/containers/startupcheck/StartupCheckStrategyTest.java) inside_block:withIndefiniteOneShotStrategy
<!--/codeinclude-->
...
<!--codeinclude--> 
[Using minimum duration strategy](../examples/junit5/generic/src/test/java/org/testcontainers/containers/startupcheck/StartupCheckStrategyTest.java) inside_block:withMinimumDurationStrategy
<!--/codeinclude-->
...
<!--codeinclude--> 
[Depending on another container](../examples/junit5/generic/src/test/java/generic/DependsOnTest.java) inside_block:dependsOn
<!--/codeinclude-->
