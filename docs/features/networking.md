...
<!--codeinclude-->
[Exposing ports](../examples/junit5/generic/src/test/java/generic/MultiplePortsExposedTest.java) inside_block:container
<!--/codeinclude-->
...
<!--codeinclude-->
[Retrieving actual ports at runtime](../examples/junit5/generic/src/test/java/generic/MultiplePortsExposedTest.java) inside_block:fetchPortsByNumber
<!--/codeinclude-->
...
<!--codeinclude-->
[Retrieving the first mapped port](../examples/junit5/generic/src/test/java/generic/MultiplePortsExposedTest.java) inside_block:fetchFirstMappedPort
<!--/codeinclude-->
...
<!--codeinclude-->
[Getting the container host](../examples/junit5/generic/src/test/java/generic/MultiplePortsExposedTest.java) inside_block:getHostOnly
<!--/codeinclude-->

It is normally advisable to use `getHost` and `getMappedPort` together when constructing addresses - for example:

<!--codeinclude-->
[Getting the container host and mapped port](../examples/junit5/generic/src/test/java/generic/MultiplePortsExposedTest.java) inside_block:getHostAndMappedPort
<!--/codeinclude-->
...
<!--codeinclude-->
[Exposing the host port](../examples/junit5/generic/src/test/java/generic/HostPortExposedTest.java) inside_block:exposePort
<!--/codeinclude-->
...
<!--codeinclude-->
[Accessing the exposed host port from a container](../examples/junit5/generic/src/test/java/generic/HostPortExposedTest.java) inside_block:useHostExposedPort
<!--/codeinclude-->
