...
<!--codeinclude-->
[Specifying a startup command](../examples/junit5/generic/src/test/java/generic/CommandsTest.java) inside_block:startupCommand
<!--/codeinclude-->
...
<!--codeinclude-->
[Executing a command inside a running container](../examples/junit5/generic/src/test/java/generic/ExecTest.java) inside_block:standaloneExec
<!--/codeinclude-->
...
<!--codeinclude-->
[Executing a command inside a running container and reading the result](../examples/junit5/generic/src/test/java/generic/ExecTest.java) inside_block:execReadingStdout
<!--/codeinclude-->
