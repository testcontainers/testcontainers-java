...
public class TimeplusContainer extends JdbcDatabaseContainer<TimeplusContainer> {
    ...
    private static final DockerImageName DEFAULT_IMAGE_NAME = DockerImageName.parse("ghcr.io/timeplus-io/proton:latest");

    private static final DockerImageName TIMEPLUS_IMAGE_NAME = DockerImageName.parse("ghcr.io/timeplus-io/proton:latest");
    ...
    private static final String DRIVER_CLASS_NAME = "com.github.timeplus.jdbc.TimeplusDriver";
