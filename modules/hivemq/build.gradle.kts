...
dependencies {
    ...
    shaded("org.apache.commons:commons-lang3:${property("commons-lang.version")}")
    shaded("commons-io:commons-io:${property("commons-io.version")}")
    shaded("org.javassist:javassist:${property("javassist.version")}")
    shaded("org.jboss.shrinkwrap:shrinkwrap-api:${property("shrinkwrap.version")}")
    shaded("org.jboss.shrinkwrap:shrinkwrap-impl-base:${property("shrinkwrap.version")}")
    shaded("net.lingala.zip4j:zip4j:${property("zip4j.version")}")
    ...
    shaded("org.jboss.shrinkwrap.resolver:shrinkwrap-resolver-api-maven-embedded:${property("shrinkwrap-resolver.version")}") {
