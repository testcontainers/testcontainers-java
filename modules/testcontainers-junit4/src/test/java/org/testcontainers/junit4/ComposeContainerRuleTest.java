...
public class ComposeContainerRuleTest {

    @Rule
    public ContainerRule<DockerComposeContainer> composeContainer = new ContainerRule<>(
    ...
    @Before
    public void setup() {
        host = composeContainer.get().getServiceHost("whoami_1", 80);
        port = composeContainer.get().getServicePort("whoami_1", 80);
    }
