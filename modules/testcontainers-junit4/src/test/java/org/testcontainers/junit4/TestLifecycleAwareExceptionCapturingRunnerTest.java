...
public class TestLifecycleAwareExceptionCapturingRunnerTest {

    @Container
    public final TestLifecycleAwareContainerMock testContainer = new TestLifecycleAwareContainerMock();
