...
public class SimpleTiberoTest extends AbstractContainerDatabaseTest {
    ...
    public static final DockerImageName TIBERO_DOCKER_IMAGE_NAME = DockerImageName.parse(
    ...
    public void testErrorPaths() {
        try (TiberoContainer tibero = new TiberoContainer(TIBERO_DOCKER_IMAGE_NAME)) {
            ...
            assertions
                .assertThatThrownBy(() -> tibero.withDatabaseName(""))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Database name cannot be null or empty");

            assertions
                .assertThatThrownBy(() -> tibero.withDatabaseName("sys"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Database name cannot be set to sys");

            assertions
                .assertThatThrownBy(() -> tibero.withUsername(""))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Username cannot be null or empty");

            assertions
                .assertThatThrownBy(() -> tibero.withUsername("sys"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Username cannot be sys");

            assertions
                .assertThatThrownBy(() -> tibero.withPassword(""))
                .isInstanceOf(IllegalArgumentException.class)
