...
/**
 * This {@link Container} is based on the official MongoDb ({@code mongo}) images from
...
public class MongoDbContainer extends GenericContainer<MongoDbContainer> {
    ...
    /**
     * Creates a new {@link MongoDbContainer} with the {@code 'mongo:4.1'} image.
     */
     ...
     *
     * @param image the image (e.g. {@code 'mongo:4.1'}) to use
     */
