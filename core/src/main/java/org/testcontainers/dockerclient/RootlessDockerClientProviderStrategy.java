...
public final class RootlessDockerClientProviderStrategy extends DockerClientProviderStrategy {
    protected static final String DOCKER_SOCK_PATH = "/run/user/1000/docker.sock";
    ...
    protected boolean isApplicable() {
        return SystemUtils.IS_OS_LINUX && Files.exists(Paths.get(DOCKER_SOCK_PATH));
    }

    @Override
    public String getDescription() {
        return "Rootless Docker accessed via Unix socket (" + SOCKET_LOCATION + ")";
    }
