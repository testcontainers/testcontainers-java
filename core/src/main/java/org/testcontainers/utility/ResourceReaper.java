...
public final class ResourceReaper {
    ...
    public static String start(String dockerHostPort, String hostIpAddress, DockerClient client) {
        return start(dockerHostPort, hostIpAddress, client, false);
    }

    @SneakyThrows(InterruptedException.class)
    public static String start(String dockerHostPort, String hostIpAddress, DockerClient client, boolean withDummyMount) {
