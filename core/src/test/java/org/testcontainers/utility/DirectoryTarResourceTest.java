...
public class DirectoryTarResourceTest {
    ...
    public void simpleRecursiveFileTest() {
        ...
        assertTrue(
            "The container has a file that was copied in via a recursive copy",
            results.contains("Used for DirectoryTarResourceTest")
        );
    }
    ...
    public void simpleRecursiveFileWithPermissionTest() {
        ...
        assertThat(
            "Listing shows that file is copied with mode requested.",
    ...
    public void simpleRecursiveClasspathResourceTest() {
        ...
        assertTrue(
            "The container has a file that was copied in via a recursive copy from a JAR resource",
            results.contains("content.txt")
        );
    }
