...
public class ParsedDockerComposeFileValidationTest {
    ...
    public void shouldObtainImageNamesV1() {
        ...
        assertEquals("all defined service names are found", Sets.newHashSet("redis", "mysql"), parsedFile.getDependencyImageNames());
    }
    ...
    public void shouldObtainImageFromDockerfileBuild() {
        ...
        ParsedDockerComposeFile parsedFile = new ParsedDockerComposeFile(file);
        assertEquals("all defined service names are found", Sets.newHashSet("redis", "mysql", "alpine:3.2"), parsedFile.getDependencyImageNames());
    }
